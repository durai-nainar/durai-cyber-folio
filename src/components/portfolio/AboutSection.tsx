    ...
    <section id="about" className="py-20 cyber-bg relative">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 mb-12 cyberpunk:rgb-border-animation shadow-2xl" data-aos="fade-up" data-aos-delay="200">
