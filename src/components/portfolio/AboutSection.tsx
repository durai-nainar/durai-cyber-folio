    ...
    <section id="about" className="py-20 cyber-bg relative">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 mb-12 rgb-border shadow-2xl theme-border" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="400">
            {stats.map((stat, index) => (
              <div key={index} className="card-cyber rgb-border theme-border text-center">
