      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mt-12" data-aos="fade-up">
          <button 
            ...
            className="text-2xl font-bold cursor-pointer hover:scale-105 transition-transform text-foreground bg-background dark:text-background dark:bg-foreground light:bg-white light:text-black px-6 py-3 rounded-lg"
          >
